            ...
            {isDemoMode ? (
              ...
              <div className="mb-5 p-4 bg-emerald-50 border border-emerald-100 text-emerald-950 rounded-2xl text-xs space-y-1.5 font-sans">
                ...
                <p className="text-slate-600 leading-relaxed text-[11px]">
                  Pre-seeded sandbox accounts are not available in live mode. Please click the <strong className="text-tomato font-bold">Register Admin</strong> tab above to create your live account first.
                </p>
              </div>
            )}
